...
CREATE TABLE `order_item` (
	...
	FOREIGN KEY (`order_id`) REFERENCES `order_table`(`id`) ON UPDATE no action ON DELETE cascade
);
...
CREATE TABLE `pickup_occasion` (
	...
	`order_start` text(30) NOT NULL,
	`order_end` text(30) NOT NULL,
	`pickup_start` text(30) NOT NULL,
	`pickup_end` text(30) NOT NULL
);
